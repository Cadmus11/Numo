...
export const personalYearMeanings: Record<number, YearMeaning> = {
  1: {
    ...
    recommendedFocus: 'Focus on bold action and new beginnings. This is your year to take the lead, start fresh, and set the direction for the next nine years.',
  },
  2: {
    number: 2,
    ...
    recommendedFocus: 'Focus on relationships and cooperation. This is a year to build bridges, practice patience, and let things develop at their natural pace.',
  },
  3: {
    number: 3,
    ...
    recommendedFocus: 'Focus on creative expression and social connections. Let your light shine and share your gifts with the world.',
  },
  4: {
    number: 4,
    ...
    recommendedFocus: 'Focus on hard work and building foundations. This is a year to get practical, organized, and disciplined.',
  },
  5: {
    number: 5,
    ...
    recommendedFocus: 'Focus on embracing change and seeking adventure. Say yes to new opportunities and expand your horizons.',
  },
  6: {
    number: 6,
    ...
    recommendedFocus: 'Focus on family, home, and service. Nurture your closest relationships and create harmony in your environment.',
  },
  7: {
    number: 7,
    ...
    recommendedFocus: 'Focus on inner growth and reflection. This is a year to rest, recharge, and connect with your deeper wisdom.',
  },
  8: {
    number: 8,
    ...
    recommendedFocus: 'Focus on achievement and abundance. This is your year to reap rewards and make significant progress on your goals.',
  },
  9: {
    number: 9,
    ...
    recommendedFocus: 'Focus on completion and release. Clear away the old to make space for the new cycle beginning next year.',
  },
};
...
export const personalMonthMeanings: Record<number, MonthMeaning> = {
  1: {
    ...
    growthAreas: ['Taking independent action', 'Starting new projects', 'Leading others', 'Making decisions'],
    warnings: ['Avoid rushing into things', 'Don\'t alienate others with aggression', 'Balance action with planning'],
  },
  2: {
    number: 2,
    title: 'Month of Connection',
    energy: 'A gentle, cooperative energy perfect for building relationships and partnerships.',
    growthAreas: ['Building relationships', 'Practicing patience', 'Developing diplomacy', 'Listening to others'],
    warnings: ['Avoid over-dependency', 'Don\'t suppress your needs', 'Maintain boundaries while being kind'],
  },
  3: {
    number: 3,
    ...
    warnings: ['Avoid spreading too thin', 'Don\'t neglect responsibilities', 'Stay focused on priorities'],
  },
  4: {
    number: 4,
    title: 'Month of Structure',
    energy: 'A grounded, practical energy for building systems and establishing routines.',
    growthAreas: ['Organization and planning', 'Building habits', 'Financial management', 'Completing tasks'],
  ...
  5: {
    ...
    growthAreas: ['Embracing change', 'Taking calculated risks', 'Travel and exploration', 'Learning new things'],
  ...
  7: {
    ...
    growthAreas: ['Rest and recharge', 'Study and research', 'Meditation and reflection', 'Solo time'],
    warnings: ['Avoid isolation extremes', 'Don\'t over-analyze', 'Balance solitude with connection'],
  },
  8: {
    number: 8,
    ...
    warnings: ['Avoid workaholism', 'Don\'t prioritize money over people', 'Stay ethical in dealings'],
  },
  9: {
    number: 9,
    title: 'Month of Release',
    energy: 'A time of completion, letting go, and preparing for new beginnings.',
    growthAreas: ['Letting go of what no longer serves', 'Completing projects', 'Service to others', 'Forgiveness'],
    warnings: ['Avoid holding on too tightly', 'Don\'t rush into new things', 'Process emotions fully'],
  },
};
...
export const personalDayMeanings: Record<number, DayMeaning> = {
  1: {
    ...
    bestActivities: ['Start a new project', 'Take the lead on something', 'Make important decisions', 'Assert your needs'],
    forecast: 'A powerful day for taking initiative. Step forward with confidence and trust your ability to lead.',
  },
  2: {
    number: 2,
    title: 'Day of Connection',
    energy: 'Soft, receptive energy ideal for collaboration and building bonds.',
    bestActivities: ['Connect with loved ones', 'Collaborate on projects', 'Practice patience', 'Listen and observe'],
    forecast: 'A gentle day focused on relationships. Take time to connect with others and practice patience.',
  },
  3: {
    number: 3,
    title: 'Day of Joy',
    ...
    forecast: 'A joyful day for creativity and connection. Share your light with others and embrace spontaneity.',
  },
  4: {
    number: 4,
    title: 'Day of Work',
    energy: 'Grounded, practical energy for getting things done and building structure.',
    bestActivities: ['Organize your space', 'Complete tasks', 'Work on long-term projects', 'Handle finances'],
    forecast: 'A productive day for practical work. Focus on building solid foundations and completing responsibilities.',
  },
  5: {
    number: 5,
    ...
    forecast: 'An adventurous day full of possibility. Embrace change and say yes to unexpected opportunities.',
  },
  6: {
    number: 6,
    title: 'Day of Love',
    energy: 'Warm, nurturing energy centered on family, home, and heartfelt connections.',
    bestActivities: ['Spend time with family', 'Beautify your home', 'Help someone in need', 'Express love'],
    forecast: 'A day for love and nurturing. Focus on your loved ones and create beauty in your surroundings.',
  },
  7: {
    number: 7,
    ...
    forecast: 'A peaceful day for inner work. Take time to rest, reflect, and reconnect with your deeper self.',
  },
  8: {
    number: 8,
    title: 'Day of Power',
    ...
    forecast: 'A powerful day for achievement. Use your executive energy to make progress on important goals.',
  },
  9: {
    number: 9,
    title: 'Day of Release',
    energy: 'Compassionate energy of completion, letting go, and service to others.',
    bestActivities: ['Let go of what no longer serves', 'Forgive someone', 'Volunteer or help others', 'Complete a cycle'],
    forecast: 'A day of completion and release. Let go with grace and open your heart to compassion.',
  },
};
