        ...
        <ScrollView
          ...
          <View style={{ flexDirection: 'row', gap: 8, marginTop: 10 }}>
            <View
              ...
              <Text style={{ fontSize: 13, color: colors.onPrimaryContainer }}>
                Day {entry.personalDayNumber}
              </Text>
            </View>
            <View
              style={{
              ...
              <Text style={{ fontSize: 13, color: colors.onPrimaryContainer }}>
                Month {entry.personalMonthNumber}
              </Text>
            </View>
            <View
              style={{
          ...
          {entry.body ? (
            <View
              ...
              <Text style={{ fontSize: 15, color: colors.onSurface, lineHeight: 22 }}>
                {entry.body}
              </Text>
            </View>
          ) : null}
