...
export default function NewJournalEntryScreen() {
  ...
  const cycleNumbers = useMemo(() => {
    if (!activeProfile)
      return { personalDayNumber: 0, personalMonthNumber: 0, personalYearNumber: 0 };
              ...
              <TouchableOpacity
                ...
                <Text
                  style={{
                    fontSize: 11,
                    fontWeight: '600',
                    color: mood === m.value ? colors.onPrimary : colors.onSurfaceVariant,
                    marginTop: 4,
                  }}>
                  {m.label}
                </Text>
            ...
            {GOAL_CATEGORIES.map((c) => (
              <TouchableOpacity
                ...
                style={{
                  ...
                  borderRadius: 20,
                  backgroundColor:
                    goalCategory === c.value ? colors.primary : colors.surfaceVariant,
                }}>
                <Text
                  style={{
                    fontSize: 13,
                    fontWeight: '600',
                    color: goalCategory === c.value ? colors.onPrimary : colors.onSurfaceVariant,
                  }}>
                  {c.label}
                </Text>
              </TouchableOpacity>
          ...
          {cycleNumbers.personalDayNumber > 0 && (
            <View
              ...
              <Text style={{ fontSize: 14, color: colors.onPrimaryContainer, marginTop: 2 }}>
                Personal Day {cycleNumbers.personalDayNumber} · Month{' '}
                {cycleNumbers.personalMonthNumber} · Year {cycleNumbers.personalYearNumber}
              </Text>
            </View>
          )}
        </ScrollView>
